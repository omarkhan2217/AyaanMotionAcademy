    ...
    <div className={classes.mainContainer}>
      ...
      <div className={classes.guidingContainer}>
        <div className={classes.scholarshipContainer}>
          ...
          <div className={classes.guidingSubHeader}>Navigating higher education options can be daunting. Our advisors provide comprehensive support, from selecting the right university and course to applying for scholarships and financial aid.</div>
        </div>
        <div className={classes.counselingContainer}>
          <div className={classes.guidingHeader}>One-on-One Career Counseling:</div>
          <div className={classes.guidingSubHeader}>Personalized counseling sessions offer a safe space to explore your aspirations, address your concerns, and refine your career objectives. Our counselors are dedicated to helping you chart a course that’s true to your individual path.</div>
        </div>
      </div>
      <CareerGuidanceText
        mainHeader={"Quality Education: The Foundation of Your Future"}
        subHeader={"At Ayaan's Motion Academy, quality education is at the heart of everything we do. Our rigorous academic programs, expert faculty, and state-of-the-art learning resources are designed to provide you with a solid educational foundation. But we go beyond academics to ensure you are well-prepared for the challenges and opportunities of the future workplace."} />
      <CareerGuidanceText
        mainHeader={"Your Journey Starts Here"}
        subHeader={"Choosing a career is one of the most significant decisions you will make. At Ayaan's Motion Academy, we are committed to guiding you through this journey, providing the support, resources, and inspiration you need to achieve your dreams. Let us help you unlock your potential and pave the way to a successful and fulfilling career."} />
        <div className={classes.button}><Button label="Inquire Now" /></div>
