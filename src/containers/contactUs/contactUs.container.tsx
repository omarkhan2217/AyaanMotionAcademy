...
export const ContactUscontainer: React.FC = () => {
  const googleMap =
    "https://www.google.com/maps/place/Ayaan+Motion+Academy/@23.3753303,85.3333714,15z/data=!4m6!3m5!1s0x39f4e14349a3aea3:0xdba7bfb1df9d1c72!8m2!3d23.3753303!4d85.3333714!16s%2Fg%2F11trtb12qz?entry=ttu";
      ...
      <div className={classes.innerContainer}>
        <div className={classes.detailsContainer}>
          ...
          <div className={classes.details}>
            ...
            <a className={classes.mapLink} href={googleMap} target="_blank" rel="noopener noreferrer">
              <Button
          ...
          <div className={classes.details}>
            ...
            <div className={classes.socialMedia}>
              <a href="https://www.youtube.com/channel/UCml6M5g7DRPd6W1bcX7313g">
                <YoutubeIcon />
              </a>
              <a href="https://www.instagram.com/ayaansmotionacademy/">
                <InstagramIcon />
              </a>
              <a href="https://twitter.com/ayaansmotion">
                <TwitterIcon />
              </a>
              <a href="https://www.facebook.com/ayaansmotionacademy">
                <FacebokIcon />
              </a>
              <a href="/">
                <LinkedInIcon />
