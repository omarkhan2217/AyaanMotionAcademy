...
export const OurBatcehscomponent: React.FC<ISBatchesCardProps> = (props: ISBatchesCardProps) => {
  const { BatchName, grade, detaile1, detaile2, detaile3, detaile4, detaile5, detaile6, guide, image,isLable } = props
  return (
    ...
    <div className={classes.mainContainer}>
      <div className={classes.innerContainer}>
        <div className={classes.InfoContainer}>
          ...
          <div className={classes.imageContaienr}>
            <BatchStudentIcon /><img src={image}></img>
            <div className={classes.guide}>{guide}</div></div>
        </div>
        <div className={classes.buttonContainer} >
        <Button label={isLable ? "Register Now" : "Inquire Now" } size="md" />
        </div>
      </div>
